    ...
    return (
        <div className="home-container relative">
            ...
            <div className="relative z-10 -mt-10 md:-mt-24 pb-20">
                {(activeCategory === 'Home' || activeCategory === 'TV Shows') && (
                    <MovieRow title="Popular TV Shows" movies={trendingMovies} />
                )}
                {(activeCategory === 'Home' || activeCategory === 'Movies') && (
                    <MovieRow title="Trending Movies" movies={popularMovies} />
                )}
                {(activeCategory === 'Home' || activeCategory === 'TV Shows' || activeCategory === 'New & Popular') && (
                    <MovieRow title="Action & Thriller" movies={[...trendingMovies].reverse()} />
                )}
                {(activeCategory === 'Home' || activeCategory === 'Movies' || activeCategory === 'New & Popular') && (
